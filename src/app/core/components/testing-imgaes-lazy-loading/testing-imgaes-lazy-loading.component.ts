...
@Component({
  selector: 'app- ',
  templateUrl: './testing-imgaes-lazy-loading.component.html',
  styleUrls: ['./testing-imgaes-lazy-loading.component.scss']
})
export class TestingImgaesLazyLoadingComponent implements OnInit {
